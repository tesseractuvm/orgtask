import { palette, areaTokens } from '../../data/designTokens';
  ...
  return (
    <section aria-labelledby="paleta" className="border-t border-line pt-8">
      ...
      <p className="mt-1 max-w-2xl text-sm text-slate">
        Seis colores de interfaz y tres de identificación de área. Cada uno tiene una
        función asignada: ningún color entra por decoración.
      </p>
